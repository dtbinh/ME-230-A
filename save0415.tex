 ...
 \centering
  \begin{tabular}{@{}ccc@{}}
   ...
   \begin{minipage}{.3\textwidth}
    \input{plot/2_1_1.tex}
   \captionof*{figure}{At time step t=16}
   \end{minipage} &
    \begin{minipage}{.3\textwidth}
    \input{plot/2_1_2.tex}
   \captionof*{figure}{At time step t=21}
   \end{minipage} &
      \begin{minipage}{.3\textwidth}
    \input{plot/2_1_3.tex}
   \captionof*{figure}{At time step t=27}
   \end{minipage} &
      \begin{minipage}{.3\textwidth}
