...
\begin{figure}[t]
      \centering
      \subfloat[ Simulation result of scenario that has known static obstacle.\label{fig:1_1}]{\input{plot/single.tex}}\\
      \subfloat[ $M$-stability analysis for scenario that has known static obstacle.\label{fig:single_m}]{\input{plot/singleM.tex}}\\
      \subfloat[$M$-stability analysis for scenario that has known static obstacle with increased sampling rate.\label{fig:single_m_0.1Hz}]{\input{plot/simgleM_2.tex}}
...
\begin{figure}[t]
      ...
      \subfloat[$M$-stability analysis for scenario that has initially unknown static obstacle.\label{fig:2_2}]{\input{plot/multiM.tex}}
...
\begin{figure}[t]
      ...
      \subfloat[$M$-stability analysis for scenario that has initially unknown moving obstacles (with speed change).\label{fig:3_4}]{\input{plot/moveM.tex}}
...
\begin{figure}[t]
      ...
      \subfloat[$M$-stability analysis for scenario that results in dynamically unreasonable trajectory.\label{fig:badM}]{\input{plot/bad1_M.tex}}
